          ...
          : TabBarView(
              ...
              children: [
                _buildProjectList(
                  ...
                  isMultiSelect: true,
                  description:
                      'Select one or more projects to monitor. The widget will show logs from the most recently deployed project among your selection.',
                ),
                _buildProjectList(
                  projects: projects,
                  selectedId: _analyticsProjectId,
                  onSelect: (project) =>
                      _updateWidgetProject('analytics', project),
                  isMultiSelect: false,
                  description:
                      'Select the project to display visitors and bounce rate analytics.',
                ),
                _buildProjectList(
                  projects: projects,
                  selectedId: _countriesProjectId,
                  onSelect: (project) =>
                      _updateWidgetProject('countries', project),
                  isMultiSelect: false,
                  description:
                      'Select the project to display visitor locations breakdown.',
                ),
                _buildProjectList(
                  projects: projects,
                  ...
                  isMultiSelect: false,
                  description:
                      'Select the project to display 24h user totals and real-time estimation.',
                ),
              ],
            ),
    );
